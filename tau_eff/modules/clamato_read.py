def xspec(z_bin):
    ...
    :return: array of XSpectrum1D objects, corresponding redshifts and RA-DEC to find EBV values for the milky way
    ...
    plt.hist(red, bins=11, edgecolor='white', linewidth=1.2, label="Reduced Sample", color="#fd8d3c")
