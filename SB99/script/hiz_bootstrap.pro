...
vdisp = 300. ; FWHM of spectral resolution of the observations in km/s
  ...
  for I = 0,N-1 do begin
    ...
    s = mrdfits('/Users/jsmonzon/IGM-UCSC/fits/bootstrap/hiz/composite_'+model_id+'.fits', 1) ;the read in
    ...
    ;oplot, s.wavelength, s.noise, color = 'light blue', thick = 3 ;this is the error on the flux
    ;oplot, s.wavelength, cont_fit, color = 'light red', thick = 3; this is the stellar continuum fit
  
  
    ;the write out
    mwrfits, cont_fit, '/Users/jsmonzon/IGM-UCSC/fits/bootstrap/hiz/model_'+model_id+'.fits'
